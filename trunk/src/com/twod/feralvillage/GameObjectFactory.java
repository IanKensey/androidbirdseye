...
import com.twod.feralvillage.AnimationComponent.PlayerAnimations;
import com.twod.feralvillage.CollisionParameters.HitType;
import com.twod.feralvillage.EnemyAnimationComponent.EnemyAnimations;
import com.twod.feralvillage.GameObject.ActionType;
import com.twod.feralvillage.GameObject.Team;
import com.twod.feralvillage.GenericAnimationComponent.Animation;
...
public class GameObjectFactory extends BaseObject {
    ...
    public GameObject spawnPlayer(float positionX, float positionY) {
        ...
        if (staticData == null) {
            ...
            SpriteAnimation leftidle = new SpriteAnimation(PlayerAnimations.LEFTIDLE.ordinal(), 1);
            leftidle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.left), 
                    1.0f, pressAndCollectVolume, basicVulnerabilityVolume));

            SpriteAnimation rightidle = new SpriteAnimation(PlayerAnimations.RIGHTIDLE.ordinal(), 1);
            rightidle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.right), 
                    1.0f, pressAndCollectVolume, basicVulnerabilityVolume));

            SpriteAnimation upidle = new SpriteAnimation(PlayerAnimations.UPIDLE.ordinal(), 1);
            upidle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.up), 
                    1.0f, pressAndCollectVolume, basicVulnerabilityVolume));

            SpriteAnimation downidle = new SpriteAnimation(PlayerAnimations.DOWNIDLE.ordinal(), 1);
            downidle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.down), 
                    1.0f, pressAndCollectVolume, basicVulnerabilityVolume));
            
            SpriteAnimation left = new SpriteAnimation(PlayerAnimations.MOVELEFT.ordinal(), 4);
            left.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.left),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            left.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.left1), 
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            left.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.left),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            left.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.left2),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            left.setLoop(true);
            
            SpriteAnimation right = new SpriteAnimation(PlayerAnimations.MOVERIGHT.ordinal(), 4);
            right.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.right),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            right.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.right1),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            right.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.right),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            right.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.right2),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            right.setLoop(true);
            
            SpriteAnimation up = new SpriteAnimation(PlayerAnimations.MOVEUP.ordinal(), 4);
            up.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.up),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            up.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.up1),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            up.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.up),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            up.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.up2),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            up.setLoop(true);
            
            SpriteAnimation down = new SpriteAnimation(PlayerAnimations.MOVEDOWN.ordinal(), 4);
            down.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.down),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            down.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.down1),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            down.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.down),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            down.addFrame(
                    new AnimationFrame(textureLibrary.allocateTexture(R.drawable.down2),  
                            Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
            down.setLoop(true);
            ...
            staticData.add(leftidle);
            staticData.add(rightidle);
            staticData.add(upidle);
            staticData.add(downidle);
            staticData.add(left);
        ...
        sprite.playAnimation(PlayerAnimations.DOWNIDLE.ordinal());
    ...
    public GameObject spawnEnemyKabocha(float positionX, float positionY, boolean flipHorizontal) {
        ...
        Vector2 surface1Start = new Vector2(20, 12);
        Vector2 surface1End = new Vector2(20, 50);
        Vector2 surface1Normal = new Vector2(1.0f, 0.0f);
        surface1Normal.normalize();
        
        Vector2 surface2Start = new Vector2(20, 50);
        Vector2 surface2End = new Vector2(46, 50);
        Vector2 surface2Normal = new Vector2(0.0f, 1.0f);
        surface2Normal.normalize();
        
        Vector2 surface3Start = new Vector2(46, 50);
        Vector2 surface3End = new Vector2(46, 12);
        Vector2 surface3Normal = new Vector2(1, 0);
        
        Vector2 surface4Start = new Vector2(46, 12);
        Vector2 surface4End = new Vector2(20, 12);
        ...
        solidSurface.addSurface(surface4Start, surface4End, surface4Normal);
            ...
            FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = 
                new FixedSizeArray<CollisionVolume>(1);
            basicVulnerabilityVolume.add(new AABoxCollisionVolume(10, 10, 54, 54, HitType.COLLECT));
                    
            SpriteAnimation idle = new SpriteAnimation(NPCAnimationComponent.IDLE, 1);
            idle.addFrame(new AnimationFrame(
                    textureLibrary.allocateTexture(R.drawable.down), 
                    Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
