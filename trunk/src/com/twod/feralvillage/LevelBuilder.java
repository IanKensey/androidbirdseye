...
public class LevelBuilder extends BaseObject {
    ...
    private final static int BACKGROUND_VILLAGE = 7;
    private final static int BACKGROUND_ROOM = 8;
    private final static int BACKGROUND_TEST = 9;
        ...
        if (textureLibrary != null) {
            ...
            switch (backgroundImage) {
                ...
                case BACKGROUND_LAB:
                    ...
                    break;
                case BACKGROUND_VILLAGE:
                    backgroundResource = R.drawable.background_village;
                    break;
                case BACKGROUND_ROOM:
                    backgroundResource = R.drawable.room;
                    break;
                case BACKGROUND_TEST:
                    backgroundResource = R.drawable.background_testvillage;
                    break;
                default:
                    assert false;
            }
            ...
            if (backgroundResource > -1) {
                ...
                final int idealSize = (int)Math.max(params.gameWidth, params.gameHeight);
